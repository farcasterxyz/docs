...
verified eth address in the Farcaster account. See [here](/developers/guides/writing/verify-address) for how to
...
create messages, see [this guide](/developers/guides/writing/messages).
