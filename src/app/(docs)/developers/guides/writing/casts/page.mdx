...
Creating simple casts is covered in the [messages](/developers/guides/writing/messages) tutorial. This tutorial covers advanced topics like mentions, embeds, emojis, replies and channels.

## Setup

- See the setup instructions in [creating messages](/developers/guides/writing/messages)
