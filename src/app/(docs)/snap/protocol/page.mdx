...
and can be multi-page, stateful, and dynamic. Snaps are defined by a JSON response served
...
that POSTs to the server, and the server returns the appropriate previous page. The server
is responsible for maintaining navigation state.
