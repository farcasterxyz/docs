...
A unique numeric identifier which every farcaster account is associated with.

### FName

A unique lowercase username which can be registered to a FID and is eventually transferrable.
