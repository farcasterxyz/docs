...
We recently released a new [Mini Apps standard](https://miniapps.farcaster.xyz/) to enable even better in-feed experiences. **Frames v1 have been deprecated and will be supported only until end of March 2025.** We strongly recommend using Mini Apps for all new projects.
:::
...
1. [Build your first mini app](https://miniapps.farcaster.xyz/docs/getting-started)
2. Read through the [formal Mini Apps Specification](https://miniapps.farcaster.xyz/docs/specification).
